...
class ExpiredMembersAlreadyController extends Controller
{
    public function index()
    {
        return view('system.admin.pages.members_expired_already.member_expired_already');
    }
    ...
    public function getExpiredMembers(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($new_data)
                ...
                ->rawColumns(['multi_send','finished_date','name','phone','action'])
                ->make(true);
        }
    }
}
