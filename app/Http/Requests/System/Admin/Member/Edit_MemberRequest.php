...
class Edit_MemberRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'name'       =>            ['required'],
            'phone'      =>            ['required','regex:/^([0-9\s\-\+\(\)]*)$/','min:10','unique:members,phone,'.$this->id],
    ...
    public function messages()
    {
        return [
            ...
            'password.min'            =>    'كلمة السر  يجب ان تكون اكثر من 6 عناصر',
