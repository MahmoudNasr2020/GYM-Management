...
@section('content')
    <section id="basic-vertical-layouts">
        <div class="row match-height">
            @include('system.admin.pages.members.components.include.table')
        </div>
    </section>
    @include('system.admin.pages.members.components.include.add')
    @include('system.admin.pages.members.components.include.edit')
@stop
@section('script')
